...
import { ItemInput, ItemSelect, ItemRadio } from '../../component/FormItemComponent';
...
class HehTable extends Component {
  ...
  hehRadioa = (layout, item, index, defaultValue) => {
    const sizeGrade = { xs: 1, md: 2, xl: 3, xxl: 4 };
    const size = sizeGrade[this.JudgeWidth()];
    return (
      <Col
        ...
        <Form onSubmit={this.submit}>
          ...
          <Row align='middle' type="flex">
                ...
                return (
                  item.type === 'input' ?
                    ...
                    : item.type === 'select' ?
                      ...
                      : item.type === 'radio' ?
                        this.hehRadioa(layout, item, index, defaultValue)
                        : item.type === 'date' ?
            ...
            <Col xs={24} xl={8} md={12} xxl={6} style={{ marginBottom: 24 }}>
              ...
              <span> </span>
              <Button onClick={this.props.addList} icon='plus' style={{ display: isShowAddBtn ? 'inline-block' : 'none' }}>新增</Button>
            </Col>
          </Row>
          {/*按钮组*/}
